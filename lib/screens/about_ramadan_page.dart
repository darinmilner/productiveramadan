              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Ramadan, the month of mercy, Quran, fasting and connecting with Allah. We see Ramadan come and go year in and year out, and each Ramadan we plan to do so much, but most end up falling short when the reality of fasting for 30 days hits us. Have you ever wanted a better way to keep track of your Ramadan activities, or better organization of your Ramadan schedules and habits? ",
                      style: TextStyle(
                        fontSize: 18.0,
